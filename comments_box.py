list_of_comments = []
language = input("Select language. Type p or persian for Persian, and n or english for English\n")
if language.lower() == 'n' or language.lower() == 'english':
...
elif language.lower() == 'p' or language.lower() == 'persian':
    ...
    if question_for_delete == 'بله':
        delete_number = int(input("شماره نظری که میخواهید حذف کنید را وارد کنید (از 0 شروع میشود)\n"))
        deleted_comment = list_of_comments.pop(delete_number)
